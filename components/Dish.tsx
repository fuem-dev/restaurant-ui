...
interface DishProps {
 ...
 onAddToCart: (id: number) => void;  // Función para agregar al carrito
 onRemoveFromCart: (id: number) => void;  // Función para remover del carrito
 hideButtons?: boolean;  // Propiedad para ocultar los botones
 displayAsTable?: boolean;  // Nueva propiedad para mostrar como tabla
}


const Dish: React.FC<DishProps> = ({ title, id, image, difficulty, onAddToCart, onRemoveFromCart, hideButtons, displayAsTable }) => {
